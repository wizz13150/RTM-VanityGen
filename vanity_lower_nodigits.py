...
def find_it(string: str):
    ...
    with open(file, "a") as f:
        while found < options.max:
            ...
            address_count += 1
            address_total += 1
            if address.startswith(string) and address[1:].islower() and not any(c.isdigit() for c in address):
...
def main():
    ...
    print("")
    print("Looking for lowercase without digits")
